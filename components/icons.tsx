...
export const ArrowUpIcon = ({color}: IconSvgProps) => {
  return (
...
export const ArrowDownIcon = ({color}: IconSvgProps) => {
  return (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={color} className="size-6">
...
export const ListIcon = ({color}: IconSvgProps) => {
  return (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={color} className="size-6">
